...
var splashscreen_controller_1 = require("./controllers/splashscreen.controller");
var input_controller_1 = require("./controllers/input.controller");
var db_controller_1 = require("./controllers/db.controller");
var App = /** @class */ (function () {
    function App() {
        var db = new db_controller_1.DBController();
        var sc = new splashscreen_controller_1.SplashScreen();
        var ic = new input_controller_1.InputController();
    }
    return App;
}());
var notitasApp = new App();

},{"./controllers/db.controller":3,"./controllers/input.controller":4,"./controllers/splashscreen.controller":6}],2:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var Collections = __importStar(require("typescript-collections"));
...
},{"typescript-collections":24}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var idb_keyval_1 = require("idb-keyval");
var DBController = /** @class */ (function () {
    function DBController() {
        exports.CUSTOM_STORE = new idb_keyval_1.Store('notitas', 'notas');
        exports.CUSTOM_STORE._dbp.then(function (r) { return console.log(r); }).catch(function (e) { return console.error(e); });
    }
    return DBController;
}());
exports.DBController = DBController;

},{"idb-keyval":8}],4:[function(require,module,exports){
"use strict";
...
var InputController = /** @class */ (function () {
    ...
    InputController.prototype.ExpandTextArea = function () {
        ...
        contenido.addEventListener('keyup', function (evt) {
            var oField = contenido;
            if (oField.scrollHeight > oField.clientHeight) {
                oField.style.height = oField.scrollHeight + "px";
            }
            if (evt.key == 'Enter') {
                var note = new note_1.Note('', contenido.value);
                console.log(note.toString());
                _this.TextArea.style.height = _this.TextAreaInitialHeigth;
                _this.NoteController.saveNote(note);
                contenido.value = '';
            }
        });
    };
    InputController.prototype.showNotes = function () {
        var _this = this;
        ...
        notesBtn.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
            var notes;
            var _this = this;
     ...
     */
    InputController.prototype.editNote = function (note, el) {
        var _this = this;
    ...
    InputController.prototype.closeNotes = function () {
        var _this = this;
        var closeNotesBtn = document.getElementById('close');
        closeNotesBtn.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                animejs_1.default({
                    targets: '.notitas',
                    easing: 'linear',
...
},{"../classes/note":2,"./note.controller":5,"animejs":7}],5:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var NoteController = /** @class */ (function () {
    ...
    NoteController.prototype.saveNote = function (note) {
        idb_keyval_1.set(note._id, note, db_controller_1.CUSTOM_STORE).then(function (result) { return console.log(result); }).catch(function (e) { return console.error(e); });
    };
    /**
    ...
    NoteController.prototype.getNotes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, idb_keyval_1.keys(db_controller_1.CUSTOM_STORE)
    ...
    NoteController.prototype.getIndividualNote = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, idb_keyval_1.get(id, db_controller_1.CUSTOM_STORE)
                            .then(function (r) {
                            var note = new note_1.Note(r.title, r.content);
                            note._id = +id;
                            return note;
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
...
},{"../classes/note":2,"./db.controller":3,"idb-keyval":8}],6:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
var SplashScreen = /** @class */ (function () {
    function SplashScreen() {
        this.init();
        var loopCompleted = 0;
        var splashAnimation = animejs_1.default({
            ...
            delay: animejs_1.default.stagger(200, { grid: [14, 5], from: 'center' }),
            loop: true,
            loopComplete: function (anim) {
                ...
                if (loopCompleted == 1) {
                    ...
                    animejs_1.default({
                        ...
                        opacity: '.1',
                        loopComplete: function (anim) {
                            var splashScreen = document.getElementById('splash').style.zIndex = '0';
                        }
                    });
                }
            }
    ...
    SplashScreen.prototype.init = function () {
        var w = window.innerWidth, h = window.innerHeight, splash = document.getElementById('splash'), wrapper = document.createElement('div'), shadows = document.createElement('div'), rows = 15, columns = 15;
        //Ej: Ancho 1538 / 10 = 153.8px
        //Ej: Alto 798  / 10 = 79.8px 
        var i, boxHeight = h / 15, boxWidth = w / 15;
...
},{"animejs":7}],7:[function(require,module,exports){
/*
 * anime.js v3.1.0
...
},{"./BSTreeKV":10}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Queue":20,"./util":25}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
...
},{"./Dictionary":12,"./Set":21,"./util":25}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
...
},{"./Dictionary":12,"./util":25}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./arrays":23,"./util":25}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Dictionary":12,"./util":25}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var arrays = require("./arrays");
...
},{"./arrays":23,"./util":25}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var Dictionary_1 = require("./Dictionary");
...
},{"./Dictionary":12,"./arrays":23,"./util":25}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Direction;
(function (Direction) {
...
},{"./Heap":14,"./util":25}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./LinkedList":16}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var arrays = require("./arrays");
...
},{"./Dictionary":12,"./arrays":23,"./util":25}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var LinkedList_1 = require("./LinkedList");
...
},{"./LinkedList":16}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
/**
...
},{"./BSTree":9,"./BSTreeKV":10,"./Bag":11,"./Dictionary":12,"./FactoryDictionary":13,"./Heap":14,"./LinkedDictionary":15,"./LinkedList":16,"./MultiDictionary":17,"./MultiRootTree":18,"./PriorityQueue":19,"./Queue":20,"./Set":21,"./Stack":22,"./arrays":23,"./util":25}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
